...
/**
 * A control that allows selection of between two somnus.common.apply.MultiSelect controls.
 */
Ext.define('somnus.common.apply.ItemSelector', {
    extend: 'somnus.common.apply.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['Ext.ux.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'somnus.common.apply.MultiSelect'
    ],
    ...
    createList: function(title){
        ...
        return Ext.create('somnus.common.apply.MultiSelect', {
